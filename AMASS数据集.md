...
poses 的形状是 (360,156)，本质上表示“360 帧动作，每一帧有 156 个姿态参数”。AMASS 这里用的是 SMPL+H 风格的姿态参数，每帧可以 reshape 成 (52,3)。这里的 52 个关节，每个关节用 3 维轴角表示旋转，所以：156=52×3。更细一点可以拆成：156=3+63+45+45。
